...
test('diagnostics and self-check endpoints return structured companion health details', async (t) => {
  ...
  assert.equal(typeof diagnostics.payload.automation.workflowCapableJobs, 'number')
  assert.equal(typeof diagnostics.payload.automation.activeWorkflowRuns, 'number')
  assert.equal(typeof diagnostics.payload.automation.scheduledWriteEnforcements, 'object')
  assert.equal(typeof diagnostics.payload.automation.scheduledWriteEnforcements.extensionHard, 'number')
  assert.equal(typeof diagnostics.payload.automation.scheduledWriteEnforcements.promptOnly, 'number')
